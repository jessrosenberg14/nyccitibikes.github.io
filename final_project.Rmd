...
manhattan_rides_df %>% 
  ...
  labs(title = "Number of CitiBike Rides in 2019 and 2020") + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1, color = rep(c("black", rep("transparent", each = 10)), 365))) +
  theme(plot.title = element_text(hjust = 0.5))
```

Overall and as expected, there were more CitiBike rides in 2019 beginning in the peak months of the pandemic in 2020. 
...
We can see by comparing averages, females take longer rides than males across all age groups. Interestingly though there are more outliers for trip duration among males than females. On average younger riders take longer rides compared to older riders. Rides never surpassed 35 minutes. This makes sense because Citi Bike members get charged extra fees for trips over 40 mins. 
