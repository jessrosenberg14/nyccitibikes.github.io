...
After examining the available data, we found that these data were relatively complete and detailed. After some initial Googling, we found that our question was of significant interest to [other New Yorkers](https://medium.com/qri-io/building-a-daily-aggregate-dataset-from-raw-citibike-trip-data-2b6502009871), as well. 
